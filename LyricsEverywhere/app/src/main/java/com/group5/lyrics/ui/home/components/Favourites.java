...
public class Favourites extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        displayAllFavourites(root, loader);
        return root;
    }
    ...
    void displayAllFavourites(View root, LoaderInterface loader) {

        RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(
                RelativeLayout.LayoutParams.WRAP_CONTENT, RelativeLayout.LayoutParams.WRAP_CONTENT);
        LinearLayout linearLayoutFavourites = root.findViewById(R.id.favouritesAll);

        if (loader.getAllFavouritesTracks().isEmpty()) {
        } else {
            for (int i = 0; i < loader.getAllFavouritesTracks().size(); i++) {
                createGridTrackAndDisplayFavourites(params, linearLayoutFavourites, loader.getAllFavouritesTracks().get(i));
    ...
    private void createGridTrackAndDisplayFavourites(RelativeLayout.LayoutParams params, LinearLayout linearLayoutFavourites, TrackInterface track) {
        ...
        newTrack.addView(t);
        linearLayoutFavourites.addView(newTrack);
        ...
        newTrack.setOnClickListener(v -> {
         ...
         fl.removeAllViews();
         getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.homePage, new LyricsPage(track), "BFragment").commit();
    ...
    public void onResume() {
        ...
        getView().setOnKeyListener((v, keyCode, event) -> {
            ...
            if (event.getAction() == KeyEvent.ACTION_UP && keyCode == KeyEvent.KEYCODE_BACK) {
                ...
                FrameLayout fl = getActivity().findViewById(R.id.favouritesFragment);
                fl.removeAllViews();
                fragmentTransaction.replace(R.id.favouritesFragment, fragment);
